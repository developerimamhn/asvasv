...
const Footer = () => {
    return (
        <div className="">
            <div className='bg-[#F3F3F3] py-[25px] lg:py-[40px]'>
                <div className="container mx-auto">
                    <div className="flex justify-between items-center flex-col sm:flex-row gap-7 sm:gap-0">
            ...
            <div className="">
                <h1 className='footerlawstcommit text-[12px] lg:text-[20px] bg-[#000] text-[#fff] py-[15px] lg:py-[29px]'>© puggy 2024 - All Rights Reserved </h1>
            </div>
        </div>    
    );
};
