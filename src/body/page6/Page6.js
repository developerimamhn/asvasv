...
const Page6 = () => {
    return (
        <div>
            <div className="container mx-auto my-[50px] md:my-[70px] lg:my-[90px] xl:my-[120px] 2xl:my-[150px]">
                <h2 className='partner text-[30px] sm:text-[40px] md:text-[50px] lg:text-[60px] xl:text-[80px] 2xl:text-[100px] uppercase mb-[20px] sm:mb-[25px] lg:mb-[40px]'>partner</h2>
                <div className="px-[15%]">
